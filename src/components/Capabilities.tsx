    ...
    <section className="py-[120px] px-margin-mobile md:px-margin-desktop bg-white">
      <div className="max-w-container-max mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-6">
          ...
          <a
            className="group flex items-center gap-2 font-body text-sm font-semibold text-azure-blue hover:text-opacity-80 transition-colors"
            href="#"
          >
            Browse all services
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {capabilities.map((item, idx) => (
            <div key={idx} className="capability-item group h-80 relative">
              <img
